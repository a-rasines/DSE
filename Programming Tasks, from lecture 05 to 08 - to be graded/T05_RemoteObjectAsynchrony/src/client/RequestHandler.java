...
public class RequestHandler {
	...
	public static void setInstance(int port) throws UnknownHostException, IOException {
		System.out.println("[Request Handler] Creating new instance on port " + port);
	...
	public String sendMessageAndWait(String message) throws IOException {
		System.out.println("[Request Handler] Handling send");
		out.println(message);
		System.out.println("[Request Handler] Waiting for response");
		return in.readLine();
	}
	
	public void endConnection() throws IOException {
		System.out.println("[Request Handler] Closing connection");
		out.close();
		in.close();
		socket.close();
	}
